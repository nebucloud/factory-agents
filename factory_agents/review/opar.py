...
from factory_agents.llm import NullLLM, ReviewLLM, merge_llm_findings
...
def run_review(
    ...
    """
    Observe: parse diff
    Plan: select heuristic (+ optional LLM)
    ...
    return merge_llm_findings(report, llm or NullLLM(), diff_text)
